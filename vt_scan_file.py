...
def scan_file(file_path:str):
        ...
        while not Finished:
                ...
                if result.status == "completed":
                        Finished = True
                        with open("/virus-total/scan_statistics.txt", "a") as stats_file:
...
if __name__ == "__main__":
        ...
        logging.basicConfig(filename="/virus-total/vt_scan.log", encoding="utf-8", level=logging.DEBUG)
